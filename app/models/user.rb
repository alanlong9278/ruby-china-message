...
class User
  ...
  # 每个用户可以写多封站内信也可以收多封站内信
  has_many :messages, dependent: :delete
  has_many :received_messages, class_name: 'MessageStatus',  inverse_of: :recipenter, dependent: :delete
  has_many :send_messages, class_name: 'MessageStatus', inverse_of: :sender, dependent: :delete
